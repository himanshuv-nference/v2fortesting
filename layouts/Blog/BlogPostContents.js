...
export default function BlogPostContents({ article }) {
                ...
                {open && (
                  ...
                  >
                    <div className={listingStyles.iconDiv}>
                      <Icon
                        className={listingStyles.iconDivIndex}
                        onClick={modalClose}
                      >
                    ...
                    <div className={listingStyles.blogImageModal}>
                      <DynamicOpenSeaViewer
                        className={listingStyles.viewer}
                        src={obj.primary.image.url}
                        test={article.data.blog_image}
                      />
                    </div>
                  </NferxModal>
                )}
              </div>
              <T className={listingStyles.blogImageCaption}>
                {obj.primary.caption[0].text}
              </T>
            </div>
          ))}
        </div>
